function [ges1,ges2,ges3,ges4,ges5,ges6,ges7,ges8] = igualacion_muestras(gp1,gp2,gp3,gp4,gp5,gp6,gp7,gp8)
    ...
    ges1=abs(ge1(1:valor));
    ges2=abs(ge2(1:valor));
    ges3=abs(ge3(1:valor));
    ges4=abs(ge4(1:valor)); 
    ges5=abs(ge5(1:valor));
    ges6=abs(ge6(1:valor));
    ges7=abs(ge7(1:valor));
    ges8=abs(ge8(1:valor));
end
